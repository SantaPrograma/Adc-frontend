...
export default function DatosNinoForm({ datos, onChange, onNext }: Props) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl mx-auto bg-white p-6 rounded shadow">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input type="number" name="edad" value={datos.edad} onChange={handleChange} required min={2} max={5} className="w-full border rounded p-2" />
        </div>
        ...
        <div>
          ...
          <input
            ...
            required={datos.seguroSalud === "otro"}
          />
        </div>
